...
@Singleton
class MovieRepository @Inject constructor(private val gson: Gson, private val movieDao: MovieDao) {
      ...
      "videos": [
        ...
        },
        {
          ...
          "title": "What care can you get for a grand?"
            ...
            """
        val mediaResponseType = object : TypeToken<MediaResponse>() {}.type
        val mediaResponse: MediaResponse = gson.fromJson(mediaJSON, mediaResponseType)
        return mediaResponse.categories.firstOrNull()?.videos ?: emptyList()
    }
