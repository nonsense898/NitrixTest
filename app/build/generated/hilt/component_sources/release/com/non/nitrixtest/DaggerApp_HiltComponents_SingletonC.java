...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(LazyClassKeyProvider.com_non_nitrixtest_viewmodel_MainViewModel, MainViewModel_HiltModules.KeyModule.provide(), LazyClassKeyProvider.com_non_nitrixtest_viewmodel_NetworkViewModel, NetworkViewModel_HiltModules.KeyModule.provide()));
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(LazyClassKeyProvider.com_non_nitrixtest_viewmodel_MainViewModel, ((Provider) mainViewModelProvider), LazyClassKeyProvider.com_non_nitrixtest_viewmodel_NetworkViewModel, ((Provider) networkViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.non.nitrixtest.viewmodel.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.provideMovieRepositoryProvider.get());

          case 1: // com.non.nitrixtest.viewmodel.NetworkViewModel 
